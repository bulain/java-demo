...
<c:url var="url" value="/person/list" />
        ...
        <tr>
            <td colspan="4">
                <table cellspacing="0" width="100%">
                    <tr>
                        <td width="40%"><c:url var="url" value="/person/new" /><a id="lnk_new" href="${url}"><spring:message code="action.new"/><spring:message code="person.model"/></a></td>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    ...
    <c:forEach items="${persons}" var="person">
        <tr>
            ...
            <td class="minNoWrap">
            <c:url var="url" value="/person/show/${person.id}"></c:url><a href="${url}"><spring:message code="action.show"/></a>
            |<c:url var="url" value="/person/edit/${person.id}"></c:url><a href="${url}"><spring:message code="action.edit"/></a>
            |<c:url var="url" value="/person/destroy/${person.id}"></c:url><a onclick="javascript:destroy(this);return false;" href="${url}"><spring:message code="action.destroy"/></a>
            </td>
        </tr>
    </c:forEach>
</table>
