...
<html>
<head>
    <title><s:text name="mailTemplate.model"/><s:text name="title.list"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="mailTemplate.model"/><s:text name="title.list"/></td>
    </tr>
</table>
<br/>

<s:form action="list" method="post" id="search" namespace="/mailTemplate" theme="simple">
    <table class="page-form" cellspacing="0" width="100%">
        <tr>
        ...
        <tr>
            ...
            <td class="page-form-value"><s:select name="search.lang" list="listReferenceLang" listKey="key" listValue="value" value="search.lang" /></td>
        </tr>
        <tr>
            <td width="20%"></td>
            <td width="30%"></td>
        ...
        <tr>
            <td colspan="4">
                <table cellspacing="0" width="100%">
                    <tr>
                        <td width="40%"><s:url id="url" action="new" /><a href="<s:property value="#url"/>"><s:text name="action.new"/><s:text name="mailTemplate.model"/></a></td>
...
<table id="list" class="list-table" cellspacing="0" width="100%" border="1">
    <tr class="list-table-header">
        <th><page:order fixOrderBy="name"><s:text name="mailTemplate.name"/></page:order></th>
        <th><page:order fixOrderBy="lang"><s:text name="mailTemplate.lang"/></page:order></th>
        <th><page:order fixOrderBy="subject"><s:text name="mailTemplate.subject"/></page:order></th>
    ...
    <s:iterator value="listMailTemplate" status="status">
        <tr class="<s:if test="#status.even">list-line-even</s:if><s:else>list-line-odd</s:else>" >
            ...
            <td class="noWrap"><s:property value="subject"/></td>
