...
<html>
<head>
    <title><s:text name="reference.model"/><s:text name="title.edit"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="reference.model"/><s:text name="title.edit"/></td>
    </tr>
</table>
<br/>

<s:form action="update" method="post" theme="simple">
    <s:include value="_editform.jsp"/>
