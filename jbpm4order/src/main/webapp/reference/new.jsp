...
<html>
<head>
    <title><s:text name="reference.model"/><s:text name="title.add"/></title>
</head>
<body>

<table class="page-form" cellspacing="0" width="100%">
    <tr>
        <td class="page-form-title"><s:text name="reference.model"/><s:text name="title.add"/></td>
    </tr>
</table>
<br/>

<s:form action="create" method="post" theme="simple">
    <s:include value="_newform.jsp"/>
