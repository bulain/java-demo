...
INSERT INTO `references` VALUES (111,'Referance','Boolean','Boolean','en','','createdBy',SYSDATE(),'createdBy',SYSDATE());
INSERT INTO `references` VALUES (112,'Referance','Boolean','²¼¶û','zh','','createdBy',SYSDATE(),'createdBy',SYSDATE());
