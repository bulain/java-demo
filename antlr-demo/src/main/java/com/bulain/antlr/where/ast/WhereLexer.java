// $ANTLR 2.7.7 (20060906): "src/test/resources/where_ast.g" -> "WhereLexer.java"$
...
public class WhereLexer extends antlr.CharScanner implements WhereParserTokenTypes, TokenStream
 {
public WhereLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public WhereLexer(Reader in) {
	this(new CharBuffer(in));
}
public WhereLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public WhereLexer(LexerSharedInputState state) {
	super(state);
	...
	literals.put(new ANTLRHashString("is", this), new Integer(8));
	literals.put(new ANTLRHashString("and", this), new Integer(4));
	literals.put(new ANTLRHashString("in", this), new Integer(6));
}
...
inputState.guessing--;
	...
	protected final void mNUM_CHAR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = NUM_CHAR;
		int _saveIndex;
