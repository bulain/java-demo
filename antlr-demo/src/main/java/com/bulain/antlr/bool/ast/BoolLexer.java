// $ANTLR 2.7.7 (20060906): "src/test/resources/test04.g" -> "BoolLexer.java"$
...
public class BoolLexer extends antlr.CharScanner implements BoolParserTokenTypes, TokenStream
 {
public BoolLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public BoolLexer(Reader in) {
	this(new CharBuffer(in));
}
public BoolLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public BoolLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = false;
	setCaseSensitive(false);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("between", this), new Integer(5));
	literals.put(new ANTLRHashString("null", this), new Integer(12));
	literals.put(new ANTLRHashString("like", this), new Integer(10));
	...
	literals.put(new ANTLRHashString("false", this), new Integer(7));
