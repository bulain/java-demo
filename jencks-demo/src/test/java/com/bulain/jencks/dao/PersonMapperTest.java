...
public class PersonMapperTest extends DaoTestCase {
	@Autowired
	private PersonMapper personMapper;

	@Test
	public void testDeleteByPrimaryKey() {
		int deleteByPrimaryKey = personMapper.deleteByPrimaryKey(Long
				.valueOf(101));
	...
	public void testSelectByPrimaryKey() {
		Person selectByPrimaryKey = personMapper.selectByPrimaryKey(Long
				.valueOf(102));
	...
	public void testUpdateByPrimaryKeySelective() {
		...
		int updateByPrimaryKeySelective = personMapper
